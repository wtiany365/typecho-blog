...
<script src="<?php $options->adminUrl('js/prettify.js?v=' . $suffixVersion); ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php $options->adminUrl('css/prettify.css?v=' . $suffixVersion); ?>">
<script>
